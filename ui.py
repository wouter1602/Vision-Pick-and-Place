...
class Ui:
    def __init__(self, s: Settings):
        if s.edge_detection_type:
            ...
            self.layout = [
                ...
                [sg.Text('Canny thresholds')],
                [sg.Slider((0, 255), s.edge_threshold_A, 1, orientation='h', size=(40, 15), key='-CANNY SLIDER A-',
                           tooltip='Canny threshold A'),
                 sg.Slider((0, 255), s.edge_threshold_B, 1, orientation='h', size=(40, 15), key='-CANNY SLIDER B-',
    ...
    def _update_img(self, s: Settings, v: Video):
        ...
        if s.edge_detection_type:
            ...
            imgbytes_object = cv.imencode('.png', v.video_lines)[1].tobytes()
